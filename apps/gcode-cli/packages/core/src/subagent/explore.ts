...
import type { EnvInfo } from "@gcode/contracts";
...
export function buildExploreAgentPrompt(options: ExploreAgentPromptOptions): string {
  ...
  return [
    "You are GCode Explore, a file search and codebase research specialist for GCode CLI. You excel at thoroughly navigating and exploring codebases.",
    "",

...
} from "@gcode/contracts/browser-control";
...
const locatorDetails = Symbol("gcode.playwright.locatorDetails");
const setObjectWrapper = Symbol("gcode.playwright.setObjectWrapper");

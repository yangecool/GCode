...
export type ContextSource =
  ...
  | "desktop_context" // GCode Desktop 渲染与交互协议
...
export type PresentationSurface = "terminal" | "gcode_desktop";
...
export interface ContextBuilderConfig {
   ...
   * 其余动态段（env/skills/用户指令/memory）保持 GCode 体系。由宿主按
 ...
 * core 只消费数据，不持有任何引擎知识；压缩/续写方言缺省走 GCode 机制。
 */

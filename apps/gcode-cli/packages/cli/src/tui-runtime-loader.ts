...
import type { runTui } from "@gcode/tui";
...
const assetPrefix = "gcode-tui-runtime/";
const manifestAssetKey = `${assetPrefix}manifest.json`;
const packageEntryPath = "node_modules/@gcode/tui/dist/index.js";

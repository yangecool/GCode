...
import type { GlobalOptions, JsonValue, RunContext } from "@gcode/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly GCodeAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly GCodeMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetGCodePluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetGCodePluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: GCodeAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: GCodeInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: GCodeMarketplaceSummaryData) {
  return {
    id: marketplace.id,

...
import { type TurnBackgroundAttribution, type TurnInputIntentMetadata } from "@gcode/contracts";
import type { TurnAttachment } from "@gcode/core";
import type { SendInputOptions, SendInputResult } from "../../app/types.js";
import { runWithSessionResidencyFinalization } from "../../gcode-protocol/session-residency.js";

...
// 1. URI ref（gcode-artifact:// 等带 scheme:/）——经 attachment chunk transaction 寄存的内容引用：
...
import type { TurnAttachment } from "@gcode/core";
...
async function mapAttachmentRef(app: GCodeApp, ref: AttachmentRef): Promise<TurnAttachment> {

...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@gcode/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@gcode/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@gcode/contracts").MessageId;
      keptMessageIDs?: import("@gcode/contracts").MessageId[];
      targetMessageID?: import("@gcode/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@gcode/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@gcode/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@gcode/contracts").SessionId;

import type { PermissionOptionsPolicy, PermissionUpdate } from "@gcode/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type GCodePermissionOption } from "@gcode/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 gcodePermissionUpdateSchema 是 strict，会话语义由

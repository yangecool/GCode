import { gcodeWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@gcode/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(gcodeWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);

...
import { getGCodeAgentModeSelectOptions, normalizeAvailableGCodeMode } from "@gcode/shared";
import type { GCodeSessionSettingsState, GCodeSlashCommand } from "@gcode/shared";
import type { WorkspaceConfigState } from "@gcode/shared/gcode-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpGCodeAgent 的注释）。

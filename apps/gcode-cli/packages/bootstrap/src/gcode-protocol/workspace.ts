import { parseRemoteWorkspaceIdentity, type GCodeWorkspaceRef } from "@gcode/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): GCodeWorkspaceRef {

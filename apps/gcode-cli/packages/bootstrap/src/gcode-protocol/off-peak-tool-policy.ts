import { gcodeWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@gcode/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(gcodeWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);

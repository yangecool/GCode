import { gcodeWorkspaceUpdateModelIoPreferencesParamsSchema } from "@gcode/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(gcodeWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);

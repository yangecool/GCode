import {
  gcodeProviderUpdateAccountConfigParamsSchema,
  type GCodeProviderUpdateAccountConfigResult,
} from "@gcode/shared";
...
export async function updateAccountProviderConfig(
  ...
  params: unknown,
): Promise<GCodeProviderUpdateAccountConfigResult> {
  const envelope = parseParams(gcodeProviderUpdateAccountConfigParamsSchema, params);

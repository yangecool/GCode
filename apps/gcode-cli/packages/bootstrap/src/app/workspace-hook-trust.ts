import { createDefaultFileWorkspaceHookTrustStore } from "@gcode/adapters/storage";
import {
...
import { SessionEventType } from "@gcode/contracts";
import type {
  Logger,
  SessionId,
...
import type { WorkspaceHookRuntimeRoot } from "@gcode/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.gcode/security。 */
  homeDir?: string;

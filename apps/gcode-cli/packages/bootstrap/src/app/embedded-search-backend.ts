import type { EmbeddedSearchBackend } from "@gcode/contracts";
import { getRuntimeToolRuntime } from "@gcode/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "GCODE_EMBEDDED_SEARCH_COMMAND";

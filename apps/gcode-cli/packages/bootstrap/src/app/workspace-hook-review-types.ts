...
import type { WorkspaceHookRuntimeAdmissionPort, WorkspaceHookTrustCoordinator } from "@gcode/core";
import type { WorkspaceHookReviewRequestPayload } from "@gcode/shared/gcode-protocol-v4";

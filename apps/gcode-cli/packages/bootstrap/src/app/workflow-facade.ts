...
import { createNodeExecutionAdapter } from "@gcode/adapters/exec";
...
import type { PrepareUserExecutionBoundary, GCodeAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "gcode-expert" : "gcode-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "gcode-expert" : "gcode-workflow",

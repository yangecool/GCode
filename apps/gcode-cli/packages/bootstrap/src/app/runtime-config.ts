...
import { resolveInitialModelSelection, type ModelSelectionOptions } from "@gcode/provider";
import { resolveBashTimeoutPolicy, type AgentProfile, type AgentRuntimeConfig } from "@gcode/core";
import { type BuiltInSubagentModelSelectionOverrides } from "@gcode/shared";
import {
...
export function resolveAppRuntimeConfig(input: {
  ...
  const runtimeConfig: AgentRuntimeConfig = {
    ...
    // 仅接受显式传入的会话级工具面（GCode Protocol session/create 或 CLI

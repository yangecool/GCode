...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@gcode/contracts";
 ...
 *
 *   GCodeApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）

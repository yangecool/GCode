...
import { BUILTIN_PROVIDER_TEMPLATE_IDS } from "@gcode/shared";
import { getDefaultConfigPath } from "@gcode/adapters/config";
import {
...
function importLegacyCliPersonalProviderConfig(
  ...
  // 通用 GCodeConfigFileSchema 刻意把旧 provider 留在 passthrough unknown，

import type { McpServerConfig, PluginLoadOutcome } from "@gcode/contracts";
...
export function resolveBuiltInNodeReplMcpServers(input: {
  ...
  const nodeRepl = createBundledMcpRuntimeConfig({
    ...
    env: {
      ...
      ...(browserUsePackage ? { GCODE_PLUGIN_ROOT: browserUsePackage.rootPath } : {}),
      ...(cuaPackage ? { GCODE_CUA_PLUGIN_ROOT: cuaPackage.rootPath } : {}),
    },

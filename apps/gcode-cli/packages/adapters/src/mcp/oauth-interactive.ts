...
import type { Logger, McpOAuthConfig } from "@gcode/contracts";
import {
  createLocalhostOAuthCallbackServer,
  type LocalhostOAuthCallbackServer,
} from "../auth/localhost-callback.js";
import type { SharedGCodeCredentialStore } from "../auth/shared-credentials.js";
import {
...
class InteractiveAuthorizationProvider implements OAuthClientProvider {
  ...
  private readonly credentialStore: SharedGCodeCredentialStore;
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      client_name: this.config.clientName ?? `GCode ${this.serverName}`,

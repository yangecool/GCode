...
/** 结构形状对齐 GCode `ModelUsage`（contracts/src/model/index.ts:499）。 */
...
/** 结构形状对齐 GCode `ModelToolCall`（contracts/src/model/index.ts:322）。 */
...
/** 结构形状对齐 GCode `ModelStreamEvent`（contracts/src/model/index.ts:715）的 GCode 子集。 */
...
/**
 * Convert cumulative Responses usage into disjoint counters（形状同 GCode ModelUsage）。
...
/**
 * Translate one complete Responses event stream into GCode-shaped model events.
 *

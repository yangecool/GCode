...
import { ModelApiActorKind, ModelApiOperation, ModelRequestSessionType } from "@gcode/contracts";
import { isOpenCodeGoBaseUrl } from "./opencode-session.js";
import type { ModelStatusContext } from "./runner-status.js";

const MODEL_TRACE_HEADER = "x-gcode-trace-id";
...
const MODEL_SESSION_TYPE_HEADER = "x-gcode-session-type";

import type { ModelUsageSummary, TodoItem, TurnId } from "@gcode/contracts";
import { getGCodeCopy } from "@gcode/i18n";
...
export function TuiApp({
  ...
  const initialCopy = getGCodeCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getGCodeCopy(locale), [locale]);

import type { WorkflowRunProgressEnvelope } from "@gcode/shared/gcode-protocol-v4";
import type { ModelSelection, GCodeModelOption } from "@gcode/shared";
import type {
  CollaborationMode,
  InputDelivery,
  ModelUsageSummary,
...
export type TuiModelOption = GCodeModelOption;

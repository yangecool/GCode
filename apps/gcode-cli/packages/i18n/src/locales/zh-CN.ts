...
export const zhCN: GCodeCopy = {
  ...
  cli: {
    ...
    help: (version) => `gcode ${version}

用法:
  gcode [command] [options]

不传 command 时，gcode 会打开全屏 TUI。

命令:
  app-server 运行 G Code Protocol stdio app server
...
`,
  ...
  tui: {
    ...
    terminal: {
      starting: "正在启动 G Code… Ctrl+C 退出",

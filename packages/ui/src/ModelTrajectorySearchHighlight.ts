...
const HIGHLIGHT_NAME = "gcode-model-trajectory-find";
const ACTIVE_HIGHLIGHT_NAME = "gcode-model-trajectory-find-active";
const STYLE_ID = "gcode-model-trajectory-find-highlight-style";

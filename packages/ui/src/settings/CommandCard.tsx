...
import type { UserCommand, GCodeCommand } from "@gcode/shared";
import { isPluginCommand, isUserCommand } from "@gcode/shared";
...
export function isEditableUserCommand(command: GCodeCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "gcode";
}

interface CommandCardProps {
  command: GCodeCommand;
  onEdit?: (command: GCodeCommand) => void;
  onToggle?: (command: GCodeCommand, enabled: boolean) => void;
  isOperating?: boolean;

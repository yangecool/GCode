...
import type { CommandConfig, UserCommand, GCodeCommand } from "@gcode/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: GCodeCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: GCodeCommand[]) => (
    <SettingsResourceList
      items={items}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <CommandForm
            ...
            agentSource={editingCommand?.agentSource ?? GCODE_COMMAND_AGENT_SOURCE}
            scopeKey={formScopeKey}

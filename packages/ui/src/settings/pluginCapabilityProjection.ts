...
import { compareDocumentPluginPriority, isPluginCommand, isUserCommand } from "@gcode/shared";
...
export function selectBuiltInPlugins(
  ...
  installedPlugins: readonly GCodeInstalledPluginSummary[],
): GCodePluginInfo[] {
...
interface PluginSettingsGroups {
  installed: GCodePluginInfo[];
  builtIn: GCodePluginInfo[];
}
...
export function selectPluginsForScope(
  plugins: readonly GCodePluginInfo[],
  _installedPlugins: readonly GCodeInstalledPluginSummary[],
  _scope: GCodePluginScope,
): GCodePluginInfo[] {
...
export function selectSkillsForScope(
  ...
  scopedPlugins: readonly Pick<GCodePluginInfo, "id" | "name" | "enabled">[],
  scope: GCodePluginScope,
): SkillSummary[] {

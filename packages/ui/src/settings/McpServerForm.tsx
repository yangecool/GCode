...
import type { McpSource, GCodeMcpServer } from "@gcode/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: GCodeMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: GCodeMcpServer) => void;
}) {
  const { intl } = useGCodeIntl();

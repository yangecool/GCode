...
function hasOwnTaskMetaField<T extends keyof GCodeTaskMeta>(task: GCodeTaskMeta, key: T) {
...
function resolveMergedTaskTitle(preferredTask: GCodeTaskMeta, fallbackTask: GCodeTaskMeta): string {
...
export function mergeTaskMetaCandidates(
  ...candidates: Array<GCodeTaskMeta | null | undefined>
): GCodeTaskMeta | undefined {
  let merged: GCodeTaskMeta | undefined;

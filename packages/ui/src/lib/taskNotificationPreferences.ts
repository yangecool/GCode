const TASK_NOTIFICATION_ENABLED_STORAGE_KEY = "gcode-notification-enabled";
const TASK_NOTIFICATION_SOUND_ENABLED_STORAGE_KEY = "gcode-notification-sound-enabled";

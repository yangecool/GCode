...
export const WORKSPACE_FILE_DRAG_MIME = "application/x-gcode-workspace-file";
export const WORKSPACE_FILE_ADD_TO_CHAT_EVENT = "gcode:add-workspace-file-to-chat";
export const WORKSPACE_FILE_DRAG_STATE_EVENT = "gcode:workspace-file-drag-state";

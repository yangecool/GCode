import type { McpServerStatus, GCodeMcpServer, GCodeMcpServerStatusSnapshot } from "@gcode/shared";
...
function mapRuntimeStatusToUi(snapshot: GCodeMcpServerStatusSnapshot): MappedMcpServerStatus {

...
import type { GCodeModelTrajectoryContentPart, GCodeModelTrajectoryRecord } from "@gcode/services";
...
export function ContentPartView({
  ...
  part: GCodeModelTrajectoryContentPart;
  intl: IntlShape;
  sectionLabel?: string;
...
export function summarizeRecords(records: GCodeModelTrajectoryRecord[]): {
  totalTokens: number;
  models: string[];
} {
  let totalTokens = 0;

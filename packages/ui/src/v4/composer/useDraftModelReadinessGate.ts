...
import { isGCodeAgentProvider, GCODE_AGENT_PROVIDER, type GCodeProvider } from "@gcode/shared";
import type { IModelSelectionService, ModelSelectionView } from "@gcode/services";
import {
...
export function useDraftModelReadinessGate(params: {
  ...
  const enabled = sessionId === null && isGCodeAgentProvider(displayProvider);

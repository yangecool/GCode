...
function supportsTaskNativeSessionLogFile(_provider: GCodeProvider | null | undefined): boolean {
 ...
 *
 * 路径规则统一通过 gcodeTaskService 解析，避免 UI 层猜 provider 自己的目录结构。
 */
export function useTaskNativeSessionLogFile(
  workspacePath: string,
  taskId: string | null,
  providerHint?: GCodeProvider | null,
  ...
  }, [enabled, gcodeTaskService, providerHint, taskId, workspaceIdentity, workspacePath]);

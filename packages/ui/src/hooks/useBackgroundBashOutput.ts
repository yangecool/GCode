...
import type { BackgroundBashOutput, BackgroundBashOutputResult } from "@gcode/shared";
import { useGCodeAgentService } from "@/hooks/useGCodeAgentService.js";
...
export function useBackgroundBashOutput(target: BackgroundBashOutputTarget, visible: boolean) {
  ...
  const service = useGCodeAgentService(workspacePath, remoteSessionId, workspaceIdentity);

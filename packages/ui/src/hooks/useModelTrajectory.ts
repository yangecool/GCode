 ...
 *
 * 路径解析与文件读取都收口在 gcodeTaskService.getModelTrajectory（host 侧），
...
export function useModelTrajectory(
  ...
  }, [gcodeTaskService, taskId, workspaceIdentity, workspacePath, reloadToken]);

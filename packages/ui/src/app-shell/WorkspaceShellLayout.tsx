...
import { TID_APP_HEADER } from "@gcode/shared";
...
const WORKSPACE_SIDEBAR_WIDTH_STORAGE_KEY = "gcode:workspace-shell:sidebar-width-px";
...
export const WorkspaceShellLayout = memo(function WorkspaceShellLayoutComponent({
  ...
  usePaneSessionPersistence({
    ...
    draftFocusVersion: workspaceShellGCodeState.draftFocusVersion,
  ...
  return (
    <DesktopWindowFrame
      title={`GCode / ${getPathLeaf(workspaceAbsPath)}`}
      showHeader
      isDesktop={isDesktop}
                    ...
                    {shouldRenderWorkspaceHeader ? (
                      ...
                      >
                        <WorkspaceHeader
                          ...
                          workspaceHeaderState={workspaceShellGCodeState}
                          gitSummary={gitState.summary}

...
export interface TestActions extends TaskListE2EActions {
  ...
  /** E2E 通过真实 gcodeAgentService 拉取插件 overview */
  getPluginsOverview: IGCodeAgentService["getPluginsOverview"];
  /** E2E 通过真实 gcodeAgentService 添加 marketplace */
  addPluginMarketplace: IGCodeAgentService["addPluginMarketplace"];
  /** E2E 通过真实 gcodeAgentService 刷新 marketplace */
  updatePluginMarketplace: IGCodeAgentService["updatePluginMarketplace"];
  /** E2E 通过真实 gcodeAgentService 安装 marketplace plugin */
  installPlugin: IGCodeAgentService["installPlugin"];
  /** E2E 通过真实 gcodeAgentService 触发插件 discover */
  listPlugins: IGCodeAgentService["listPlugins"];
  /** E2E 通过真实 gcodeAgentService 查询 Workspace/Session Plugin catalog */
  getPluginReferenceCatalog: IGCodeAgentService["getPluginReferenceCatalog"];
}

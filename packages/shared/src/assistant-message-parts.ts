export type GCodeAssistantMessagePart =
  | {
      type: "content";
      content: string;
    }
...
export function appendAssistantMessagePart(
  parts: readonly GCodeAssistantMessagePart[] | undefined,
  nextPart: GCodeAssistantMessagePart,
) {
...
export function getLatestAssistantContentPart(parts: readonly GCodeAssistantMessagePart[]) {
...
export function getLatestAssistantContentText(parts: readonly GCodeAssistantMessagePart[]) {

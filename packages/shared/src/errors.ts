...
export const GCODE_FILE_LOCK_TIMEOUT_ERROR_CODE = "GCODE_FILE_LOCK_TIMEOUT" as const;
...
export function isGCodeFileLockTimeoutError(error: unknown): boolean {
  return normalizeUnknownError(error).code === GCODE_FILE_LOCK_TIMEOUT_ERROR_CODE;
}

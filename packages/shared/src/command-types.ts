...
export type CommandAgentSource = "gcodeAgent";
...
export type GCodeCommand = UserCommand | PluginCommand;

export function isUserCommand(command: GCodeCommand): command is UserCommand {
  return command.source === "user";
}

export function isPluginCommand(command: GCodeCommand): command is PluginCommand {

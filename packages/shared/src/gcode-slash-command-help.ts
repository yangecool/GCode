export type BuiltinGCodeSlashCommandHelpEntry = {
...
export const BUILTIN_GCODE_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinGCodeSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    {
      details: ["Deletes Z.ai OAuth credentials from the shared GCode credential store."],
      name: "logout",
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.gcode/AGENTS.md.",
      ],
      name: "init",

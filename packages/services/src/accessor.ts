...
import type { IGCodeTaskService } from "./session/gcodeTaskService.js";
import type { IGCodeAgentService } from "./gcode-agent/gcodeAgent.js";
import type { IGCodeSessionService } from "./gcode-session/gcodeSession.js";
...
export interface IServiceAccessor {
  ...
  /** 设置页插件管理（UI 不再直触 gcodeAgentService 的 plugins/* 面） */

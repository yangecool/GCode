import { gcodeProtocolMethods, gcodeRuntimeCapabilitiesSchema } from "@gcode/shared";
import type { GCodeProtocolClient } from "./gcodeProtocolClient.js";
...
export function ensureIndependentPlanSupport(
  ...
  const check = client
    .request(gcodeProtocolMethods.runtimeCapabilities, {}, gcodeRuntimeCapabilitiesSchema)
    .then((result) => {

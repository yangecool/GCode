import { resolveWorkspaceKey, type GCodeComputerUseOperationEvent } from "@gcode/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: GCodeComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: GCodeComputerUseOperationEvent,
  ): void {

import { requestPluginReferenceCatalog } from "#src/gcode-agent/pluginReferenceCatalogRequest.js";
import {
  localTtftFactsSchema,
  sessionDebugSnapshotSchema,
  type LocalTtftFacts,
} from "@gcode/shared";
/* oxlint-disable eslint(max-lines) -- GCode Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
...
import {
  GCODE_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  formatLogPrefix,
  resolveWorkspaceKey,
  type TraceId,
  GCODE_AGENT_PROVIDER,
  GCODE_AGENT_PROVIDER_NOT_READY_CODE,
  GCODE_AGENT_PROVIDER_NOT_READY_REASON,
  GCODE_MODEL_REASONING_SEPARATOR,
  isRemoteWorkspaceIdentity,
  GCODE_PROTOCOL_NAME,
  GCODE_PROTOCOL_VERSION,
  gcodeMcpListResultSchema,
  gcodePermissionRequestParamsSchema,
  gcodeBrowserListParamsSchema,
  gcodeBrowserExecuteParamsSchema,
  gcodePluginsConfigureResultSchema,
  gcodePluginsInstallResultSchema,
  gcodePluginsListResultSchema,
  gcodePluginsMarketplaceMutationResultSchema,
  gcodePluginsOverviewResultSchema,
  gcodeProcessChildProcessesResultSchema,
  type GCodeProcessChildProcess,
  gcodeSkillsReferenceCatalogResultSchema,
  gcodeWorkflowsDeleteResultSchema,
  gcodeWorkflowsGetResultSchema,
  gcodeWorkflowsListResultSchema,
  gcodeWorkflowsMoveResultSchema,
  gcodeWorkflowsRunsResultSchema,
  gcodeWorkflowsUpdateMetaResultSchema,
  gcodePluginsResolveSuggestedReferenceResultSchema,
  gcodePluginOperationProgressNotificationSchema,
  gcodePluginsRestoreBuiltinResultSchema,
  gcodePluginsSetEnabledResultSchema,
  gcodePluginsCancelOperationResultSchema,
  gcodePluginsUninstallResultSchema,
  gcodePluginsValidateResultSchema,
  gcodePluginsDescribeResultSchema,
  gcodeAutomationCheckTaskBindingParamsSchema,
  gcodeAutomationCreateParamsSchema,
  gcodeAutomationDeleteParamsSchema,
  gcodeAutomationListParamsSchema,
  gcodeAutomationUpdateParamsSchema,
  gcodeOffPeakCreateParamsSchema,
  gcodeOffPeakListParamsSchema,
  OFF_PEAK_PROVIDER_IDS,
  gcodeComputerUseOperationEventSchema,
  gcodeProviderRuntimeHeadersCancelledSchema,
  gcodeProviderRuntimeHeadersRequestParamsSchema,
  gcodeProviderTestModelConnectivityResultSchema,
  gcodeOfficialMcpAuthHeadersRequestParamsSchema,
  summarizeOfficialMcpIdentityHeaders,
  gcodeProtocolEmptyResultSchema,
  gcodeProtocolMethods,
  gcodeProtocolNotifications,
  gcodeMcpTelemetryEventSchema,
  gcodeMcpResourceSamplesSchema,
  gcodeToolExecResourceSchema,
  gcodeProcessResourceSampleSchema,
  gcodeSessionCloseResultSchema,
  gcodeSessionCompactResultSchema,
  gcodeSessionEventsResultSchema,
  gcodeSessionGoalResultSchema,
  gcodeSessionListResultSchema,
  gcodeSessionSubagentsResultSchema,
  gcodeSessionMessagesResultSchema,
  gcodeSessionEventSchema,
  gcodeSessionSendResultSchema,
  gcodeSessionRequestRuntimePreferencesParamsSchema,
  gcodeSessionRuntimePreferencesResultSchema,
  gcodeSessionStateSnapshotSchema,
  gcodeSessionSubscribeResultSchema,
  gcodeStateUpdatedNotificationSchema,
  gcodeUserInputRequestParamsSchema,
  gcodeWorkspacePresentationSchema,
  gcodeWorkspaceCancelGenerateTextResultSchema,
  gcodeWorkspaceGenerateTextResultSchema,
  gcodeWorkspaceHookTrustGrantResultSchema,
  gcodeWorkspaceUpdateInteractionPreferencesResultSchema,
  gcodeWorkspaceUpdateModelIoPreferencesResultSchema,
  gcodeProviderUpdateAccountConfigResultSchema,
  type GCodeSessionStateSnapshot,
  type GCodeAutomation,
  type GCodeAutomationRun,
  gcodeWorkspaceUpdateOffPeakToolPolicyResultSchema,
  gcodeWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  type DynamicWorkflowClientConfig,
  type AgentLaneResourceSample,
  type ProcessResourceCliLane,
  type GCodeMcpTelemetryEvent,
  type GCodeMcpResourceSample,
  type GCodeToolExecResource,
  type GCodePluginOperationProgressNotification,
  type GCodeTaskMode,
} from "@gcode/shared";
...
} from "#src/gcode-agent/automationToolPolicy.js";
import { GCODE_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./gcodeAgent.js";
import type {
  GCodeProtocolRequestId,
  ModelSelection,
  GCodeProviderRuntimeHeadersRequestParams,
  GCodeSessionEvent,
  GCodeSessionRuntimePreferencesScope,
  GCodeSavedWorkflowScope,
...
import type {
  IGCodeAgentService,
  GCodeAgentBackgroundBashOutputParams,
  GCodeAgentAppRuntimePreferences,
  GCodeAgentRuntimeLifecycleEvent,
  GCodeAgentAddPluginMarketplaceParams,
  GCodeAgentAppUsageParams,
  GCodeAgentCancelPluginOperationParams,
  GCodeAgentCompactParams,
  ...
  GCodeAgentGenerateWorkspaceTextParams,
  GCodeAgentTestModelConnectivityParams,
  GCodeAgentGoalParams,
  GCodeAgentGrantWorkspaceHookTrustParams,
  GCodeAgentInitializeResult,
  GCodeAgentListSessionsParams,
  GCodeAgentListSessionSubagentsParams,
  GCodeAgentReadWorkspacePresentationParams,
  GCodeAgentReadSessionEventsParams,
  GCodeAgentReadSessionMessagesParams,
  GCodeAgentReadSessionParams,
  GCodeAgentRemovePluginMarketplaceParams,
  GCodeAgentRespondSessionRuntimePreferencesParams,
  ...
  GCodeAgentSessionRuntimePreferencesRequest,
  GCodeAgentTaskTokenUsageParams,
  ...
  GCodeAgentAttachmentReadParams,
  GCodeAgentConversationAttachmentReadParams,
  GCodeAgentConversationAttachmentStatParams,
  GCodeAgentAttachmentPreviewSourceParams,
  GCodeAgentAttachmentTerminalParams,
  GCodeAgentConversationCommandParams,
  GCodeAgentCommandsQueryParams,
  GCodeAgentConversationFileChangesParams,
  GCodeAgentConversationFileRewindPreviewParams,
  GCodeAgentConversationRowsRangeParams,
  GCodeAgentConversationPlansParams,
  GCodeAgentConversationWorkflowRunEventsParams,
  GCodeAgentConversationWorkflowRunArtifactDataParams,
  GCodeAgentConversationWorkflowRunArtifactReadParams,
  GCodeAgentConversationWorkflowRunArtifactsParams,
  GCodeAgentConversationWorkflowRunNodeResultParams,
  GCodeAgentConversationWorkflowRunWorkspaceParams,
  GCodeAgentConversationWorkflowRunsParams,
  GCodeAgentConversationResyncParams,
  GCodeAgentConversationSubscribeParams,
  GCodeAgentConversationUnsubscribeParams,
  GCodeAgentConnectionFlowParams,
  GCodeAgentSessionsIndexSubscribeParams,
  GCodeAgentWorkspaceConfigSubscribeParams,
} from "./gcodeAgent.js";
import {
...
import {
  ...
  readTrustedGCodeAgentV4UnsubscribeRoute,
} from "./gcodeAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/gcode-agent/gcodeSessionEventCoalescer.js";
...
import { GCodeAgentMcpStatusModeUnsupportedError } from "#src/gcode-agent/gcodeAgentErrors.js";
import { GCodeAgentProcessManager } from "./gcodeAgentProcessManager.js";
import type { GCodeAgentProcessManagerOptions } from "./gcodeAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  GCodeProtocolRequestTimeoutError,
  type GCodeProtocolClient,
} from "./gcodeProtocolClient.js";
import { getDataBaseDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./gcodeAgentBrowserAmbientContext.js";
import {
...
const logger = createServiceLogger("gcode-agent-service");
...
interface PendingPermissionRequest {
  client: GCodeProtocolClient;
  protocolRequestId: GCodeProtocolRequestId;
}

interface PendingProviderRuntimeHeadersRequest extends PendingPermissionRequest {
  request: GCodeProviderRuntimeHeadersRequestParams;
  responding?: boolean;
}

interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: GCodeAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return error instanceof Error && error.message === "GCode agent stdio transport is closed";
}
...
function buildWorkspaceRef(params: GCodeAgentWorkspaceTarget): GCodeWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: GCodeAgentSavedWorkflowTarget,
): params is GCodeAgentWorkspaceTarget & { scope?: GCodeSavedWorkflowScope } {
  return typeof (params as Partial<GCodeAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: GCodeAgentSavedWorkflowTarget): {
  scope?: GCodeSavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getDataBaseDir(), ".gcode", PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the GCode Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.gcode/cli/config.json (mcp.servers), which the agent
// runtime connects separately and reports via the `mcp.server.connected`/toolCount events. So a
// createSession log line with mcpServerCount:0 is EXPECTED when gcode-cua is a CLI-config MCP server
...
// real kimi-k2.6 turns call mcp__gcode-cua__* tools (get_app_state/type/open_application, status
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof GCodeProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return error instanceof Error && error.message === `GCode Protocol request timed out: ${method}`;
}
...
function buildSessionCreateParams(
  params: GCodeAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: GCodeAgentResumeSessionParams & {
    offPeakToolEnabled?: boolean;
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: GCodeAgentSendPromptParams,
...
function buildSessionCompactParams(params: GCodeAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function sessionEventKey(params: GCodeAgentSessionTarget): string {
...
function permissionRequestKey(params: GCodeAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: GCodeAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function providerRuntimeHeadersRequestKey(
  params: GCodeAgentSessionTarget & { requestId: string },
): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}
...
interface GCodeAgentProviderReadinessSnapshot {
...
): GCodeAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: GCodeAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: GCodeAgentWorkspaceTarget): Error & {
  code: typeof GCODE_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("GCode Agent runtime is not running.") as Error & {
    code: typeof GCODE_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = GCODE_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateGCodeAgentServiceOptions extends Omit<
  GCodeAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
  ...
  resolveSessionRuntimePreferences?: (
    scope: GCodeSessionRuntimePreferencesScope,
  ) => Promise<GCodeSessionRuntimePreferencesResult>;
...
function toProtocolAutomation(automation: GCodeAutomation) {
  return {
...
async function respondOffPeakInternalError(
  client: Pick<GCodeProtocolClient, "respondError">,
  request: { id: GCodeProtocolRequestId; method: string },
  workspace: GCodeAgentWorkspaceTarget,
  error: unknown,
): Promise<void> {
...
export function createGCodeAgentService(
  options?: CreateGCodeAgentServiceOptions,
): IGCodeAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new GCodeAgentProcessManager(options);
  ...
  const pluginProcessManager = new GCodeAgentProcessManager({
  ...
  const mcpStatusProcessManager = new GCodeAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<GCodeAgentServiceEvent>>();
  /**
  ...
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<GCodeAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<GCodeToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<GCodeMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<GCodeMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<GCodePluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<GCodeAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<GCodeProtocolClient>();
  const clientDisposables = new WeakMap<GCodeProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: GCodeAgentAppRuntimePreferences | undefined;
  ...
  const accountConfigSyncByClient = new WeakMap<GCodeProtocolClient, Promise<void>>();
  // 此缓存只去重已交付的账号快照，不表示 Worker 的 Registry 已应用该版本。
  const accountConfigReceivedRevisionByClient = new WeakMap<GCodeProtocolClient, string>();
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: GCodeProtocolClient): void {
  ...
  async function respondAccountRequestAuthWithoutInteraction(params: {
    ...
    try {
      ...
      logger.info(undefined, "GCode provider runtime headers 已应用", {
      ...
      if (pendingProviderRuntimeHeaders.get(params.key) !== params.pending) return;
      logger.warn(undefined, "GCode provider runtime headers 应用失败", {
        modelId: params.pending.request.modelSelection.modelId,
        providerId: params.pending.request.providerId,
        requestId: params.pending.request.requestId,
        sessionId: params.pending.request.sessionId,
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "gcode_agent.runtime_preferences.host_response_timeout",
      module: "services.gcode_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: GCODE_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
    ...
    const current = previous
      ...
      .then(async () => {
        ...
        const result = await params.client.request(
          gcodeProtocolMethods.providerUpdateAccountConfig,
          {
        ...
        logger.info(undefined, "account provider config 已交付到 GCode agent", {
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: GCodeProtocolClient;
    preferences: GCodeAgentAppRuntimePreferences;
    workspace: GCodeAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          gcodeProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            gcodeProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: GCodeAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 GCode agent", {
  ...
  function getSessionEmitter(params: GCodeAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<GCodeAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<GCodePluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: GCodeAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: GCodeAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: GCodeAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: GCodeAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function resolveV4Connection(params: unknown, fallbackConnectionId: string = v4ConnectionId) {
    return (
      readTrustedGCodeAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: GCodeAgentConversationUnsubscribeParams | GCodeAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedGCodeAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: GCodeAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: GCodeAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function handleStateUpdated(
    workspace: GCodeAgentWorkspaceTarget,
    notification: GCodeStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === gcodeProtocolNotifications.providerRuntimeHeadersCancelled) {
          const parsed = gcodeProviderRuntimeHeadersCancelledSchema.safeParse(message.params);
          if (
            !parsed.success ||
        ...
        if (message.method === gcodeProtocolNotifications.processResourceSample) {
          const parsed = gcodeProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 GCode CLI 资源样本", {
        ...
        if (message.method === gcodeProtocolNotifications.toolExecResource) {
          const parsed = gcodeToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === gcodeProtocolNotifications.mcpResourceSamples) {
          const parsed = gcodeMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === gcodeProtocolNotifications.mcpTelemetry) {
          const parsed = gcodeMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 GCode CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === gcodeProtocolNotifications.pluginOperationProgress) {
          const parsed = gcodePluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 GCode Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === gcodeProtocolMethods.computerUseOperationEvent) {
          const parsed = gcodeComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(undefined, "丢弃无效 GCode Protocol Computer Use operation event", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                message: issue.message,
                path: issue.path.join("."),
        ...
        if (message.method === "session/event") {
          const parsed = gcodeSessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 GCode Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = gcodeStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === gcodeProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const parsed = gcodeSessionRequestRuntimePreferencesParamsSchema.safeParse(
            request.params,
          );
          if (!parsed.success) {
            void client
          ...
          if (sessionRuntimePreferencesAuthority === "local") {
            void (async () => {
              let preferences: GCodeSessionRuntimePreferencesResult;
              try {
                preferences = gcodeSessionRuntimePreferencesResultSchema.parse(
          ...
          const dynamicRequest: GCodeAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "gcode_agent.runtime_preferences.host_request_dispatched",
            module: "services.gcode_agent",
            requestId,
        ...
        if (request.method === gcodeProtocolMethods.interactionRequestPermission) {
          const parsed = gcodePermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === gcodeProtocolMethods.interactionRequestUserInput) {
          const parsed = gcodeUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.interactionRequestProviderRuntimeHeaders) {
          const parsed = gcodeProviderRuntimeHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
          ...
          logger.info(request.trace?.traceId, "收到 GCode provider runtime headers 请求", {
        ...
        if (request.method === gcodeProtocolMethods.interactionRequestOfficialMcpAuthHeaders) {
          const parsed = gcodeOfficialMcpAuthHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.interactionBrowserList) {
          const parsed = gcodeBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.interactionBrowserExecute) {
          const parsed = gcodeBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.automationCreate) {
          const parsed = gcodeAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.offPeakCreate) {
          const parsed = gcodeOffPeakCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.offPeakList) {
          const parsed = gcodeOffPeakListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.automationList) {
          const parsed = gcodeAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.automationCheckTaskBinding) {
          const parsed = gcodeAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.automationUpdate) {
          const parsed = gcodeAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === gcodeProtocolMethods.automationDelete) {
          const parsed = gcodeAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported GCode Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function rememberSessionTrace(
    target: GCodeAgentSessionTarget,
  ...
  function getSessionTraceId(target: GCodeAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof GCODE_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof GCODE_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    error.code = GCODE_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: GCODE_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof GCODE_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === GCODE_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    GCodeAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 GCode Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: GCodeAgentAppRuntimePreferences | undefined;
    ...
    const offPeakToolPolicyReady = (async () => {
      ...
      try {
        await client.request(
          gcodeProtocolMethods.workspaceUpdateOffPeakToolPolicy,
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          gcodeProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
          { workspace: buildWorkspaceRef(params), enabled: true },
          gcodeWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
        );
      } catch (error) {
    ...
    logger.info(undefined, "为只读会话控制面启动 GCode agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: GCodeAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，GCode agent 保持只读"
            : "provider/model 尚未就绪，GCode agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 GCode agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<GCodeProtocolClient> {
  ...
  // homedir() 即用户家目录，全局根 `~/.gcode/workflows/` 因此解析到真实目录。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: GCodeAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveSavedWorkflowCarrier(
    params: GCodeAgentSavedWorkflowTarget,
  ): Promise<{ client: GCodeProtocolClient; workspace: GCodeWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<GCodeProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: GCodeAgentConversationCommandParams,
  ...
  return {
    ...
    async initialize(params: GCodeAgentWorkspaceTarget): Promise<GCodeAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 GCode agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "GCode agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: GCODE_PROTOCOL_NAME,
          protocolVersion: GCODE_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady ? "GCode agent 等待 provider/model 就绪" : "GCode agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: GCODE_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: GCodeAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: GCodeAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: GCodeAgentWorkspaceTarget) {
    ...
    async createSession(params: GCodeAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      logger.info(sessionTraceId, "开始请求 GCode Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          gcodeProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "GCode Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "GCode Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "GCode Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "GCode Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          gcodeProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "GCode Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: GCodeAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 GCode Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          gcodeProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "GCode Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "GCode Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "GCode Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "GCode Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: GCodeAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        gcodeProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: GCodeAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        gcodeProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: GCodeAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: GCodeAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: GCodeAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        gcodeProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: GCodeAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        gcodeProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        gcodeProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: GCodeAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        gcodeProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: GCodeAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 GCode Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: GCodeWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            ...
            presentation = await client.request(
              gcodeProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              gcodeWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error("GCode Protocol workspace/readPresentation did not return a result");
        }
        logger.info(undefined, "GCode Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "GCode Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: GCodeAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: GCodeAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new GCodeAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, gcodeProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: GCodeAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          gcodeProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, gcodeProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: GCodeAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: GCodeAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        gcodeProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: GCodeAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        gcodeProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        gcodeWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: GCodeAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        gcodeProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        gcodeWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: GCodeAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        gcodeProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        gcodeWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: GCodeAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        gcodeProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        gcodeWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: GCodeAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        gcodeProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: GCodeAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        gcodeProtocolMethods.workflowsMove,
        { workspace: buildWorkspaceRef(params), name: params.name },
        gcodeWorkflowsMoveResultSchema,
      );
    },

    async resolveSuggestedPluginReference(params: GCodeAgentResolveSuggestedPluginReferenceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsResolveSuggestedReference,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: GCodeProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              gcodeProtocolMethods.processChildProcesses,
              {},
              gcodeProcessChildProcessesResultSchema,
    ...
    async getPluginsOverview(params: GCodeAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: GCodeAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: GCodeAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: GCodeAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: GCodeAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: GCodeAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        gcodePluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: GCodeAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: GCodeAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: GCodeAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: GCodeAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: GCodeAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: GCodeAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: GCodeAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: GCodeAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        gcodeProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: GCodeAgentWorkspaceTarget) {
    ...
    async createAutomation(params: GCodeAgentCreateAutomationParams) {
      return automationService.create({
        ...
        mode: params.mode as GCodeTaskMode | undefined,
        workspacePath: params.workspacePath,
        workspaceIdentity: params.workspaceIdentity,
    ...
    async updateAutomation(params: GCodeAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as GCodeTaskMode | undefined),
    ...
    async deleteAutomation(params: GCodeAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: GCodeAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: GCodeAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: GCodeAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: GCodeAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: GCodeAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: GCodeAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      // Worker 自己读取 GCode Built-in / Personal Config；Host 只在执行前确保账号状态形成的
      ...
      const cancel = () => {
        ...
        void client
          .request(
            gcodeProtocolMethods.workspaceCancelGenerateText,
            { operationId },
            gcodeWorkspaceCancelGenerateTextResultSchema,
            { timeoutMs: 5_000 },
          )
      ...
      try {
        return await client.request(
          gcodeProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: GCodeAgentTestModelConnectivityParams) {
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      return client.request(
        gcodeProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async sendPrompt(params: GCodeAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: GCodeAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "GCode Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          gcodeProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          gcodeSessionSendResultSchema,
        );
        logger.info(logTraceId, "GCode Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "GCode Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "GCode Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: GCodeAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(sessionTraceId ?? params.inputId, "GCode Protocol session/compact 开始", {
        inputId: params.inputId,
        sessionId: params.sessionId,
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      ...
      try {
        const result = await client.request(
          gcodeProtocolMethods.sessionCompact,
        ...
        logger.info(sessionTraceId ?? params.inputId, "GCode Protocol session/compact ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId ?? params.inputId, "GCode Protocol session/compact 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          sessionId: params.sessionId,
    ...
    async goalSession(params: GCodeAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 GCode Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          gcodeProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "GCode Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "GCode Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: GCodeAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        gcodeProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: GCodeAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 GCode Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          gcodeProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "GCode Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "GCode Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: GCodeAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        gcodeProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: GCodeAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        gcodeProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      ...
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "gcode_agent.runtime_preferences.response_without_pending",
          module: "services.gcode_agent",
          requestId: params.requestId,
        });
        throw new Error(`GCode session runtime preferences request not found: ${params.requestId}`);
      }
      const responseContext = {
        event: "gcode_agent.runtime_preferences.host_response_received",
        module: "services.gcode_agent",
        requestId: params.requestId,
        scope: pending.request.scope,
        sessionId: pending.request.sessionId,
    ...
    onDynamicSessionEvent(params: GCodeAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: GCodeAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: GCodeAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              gcodeProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("gcode-agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: GCodeAgentConnectionFlowParams) {
      const trusted = readTrustedGCodeAgentV4Connection(params);
    ...
    async subscribeConversationV4(params: GCodeAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。GCode Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: GCodeAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: GCodeAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: GCodeAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedGCodeAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
      if (params.envelope.type === "createSession") {
        // V4 草稿预热直接走 command 转发；新会话创建前只需等待 Account Config，
        // GCode Built-in / Personal 已由 Worker 进程 Registry 自己装配。
        await ensureAccountProviderConfigSynced({
          client,
    ...
    async queryConversationCommandsV4(params: GCodeAgentCommandsQueryParams) {
      if (!readTrustedGCodeAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: GCodeAgentAttachmentBeginParams) {
      const trusted = readTrustedGCodeAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: GCodeAgentAttachmentChunkParams) {
      const trusted = readTrustedGCodeAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: GCodeAgentAttachmentTerminalParams) {
      const trusted = readTrustedGCodeAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: GCodeAgentAttachmentTerminalParams) {
      const trusted = readTrustedGCodeAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: GCodeAgentAttachmentReadParams) {
      if (!readTrustedGCodeAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: GCodeAgentConversationAttachmentReadParams) {
      if (!readTrustedGCodeAgentV4Connection(params)) {
        throw new GCodeAttachmentFaultError(
          GCODE_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: GCodeAgentConversationAttachmentStatParams) {
      if (!readTrustedGCodeAgentV4Connection(params)) {
        throw new GCodeAttachmentFaultError(
          GCODE_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: GCodeAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedGCodeAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: GCodeAgentConversationRowsRangeParams) {
      const trusted = readTrustedGCodeAgentV4Connection(params);
    ...
    async conversationPlansV4(params: GCodeAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: GCodeAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: GCodeAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: GCodeAgentBackgroundBashOutputParams) {
      if (!readTrustedGCodeAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: GCodeAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: GCodeAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: GCodeAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: GCodeAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: GCodeAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: GCodeAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: GCodeAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: GCodeAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: GCodeAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: GCodeAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: GCodeAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: GCodeAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: GCodeAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: GCodeAgentRuntimeLifecycleEvent) => void) {

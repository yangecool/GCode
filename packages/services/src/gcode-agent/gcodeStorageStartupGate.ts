...
export class GCodeStorageStartupGate {
  private current?: GCodeStorageStartupState;
  private terminalError?: Error;
  private pending?: Promise<void>;
  private resolve?: () => void;
  private reject?: (error: Error) => void;
  private timer?: ReturnType<typeof setTimeout>;
  private readonly changed = new Emitter<GCodeStorageStartupState>();
  ...
  get snapshot(): GCodeStorageStartupState | undefined {
    return this.current;
  }

  accept(input: unknown): boolean {
    const parsed = gcodeStorageStartupStateSchema.safeParse(input);

import type { ServiceAuthorityMode } from "@gcode/shared";

export type GCodeAgentPresentationSurface = "desktop";

interface GCodeAgentPresentationHostFacts {
...
export function resolveGCodeAgentPresentationSurface(
  facts: GCodeAgentPresentationHostFacts,
): GCodeAgentPresentationSurface | undefined {

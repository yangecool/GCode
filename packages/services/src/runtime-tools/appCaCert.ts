...
const APP_CA_CERT_FILE = "gcode-network-ca.pem";
const APP_CA_KEY_FILE = "gcode-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "GCode Network CA" },
    { name: "organizationName", value: "GCode" },
  ];

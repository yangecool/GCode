import type { Hook, GCodeWorkspaceHookTrustGrantResult } from "@gcode/shared";
import type { WorkspaceHookBundleSnapshotData } from "@gcode/shared/workspace-hook-discovery";

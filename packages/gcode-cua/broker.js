...
export const BROKER_SOCKET_ENV = "GCODE_CUA_PERMISSION_BROKER_SOCKET";
export const BROKER_UNAVAILABLE_ENV = "GCODE_CUA_PERMISSION_BROKER_UNAVAILABLE";
...
export function mintBrokerSocketPath(options = {}) {
  ...
  return join(dir, `gcode-cua-broker-${randomUUID()}.sock`);
}

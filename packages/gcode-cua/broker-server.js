...
export const HELPER_ADDON_ENV = "GCODE_CUA_HELPER_ADDON";
export const WINDOWS_DEV_CONTROL_PROTOCOL = "gcode-cua-windows-dev/v1";
...
export function isPotentialGCodeCuaAgentMcpServer(_server) {
  return false;
}

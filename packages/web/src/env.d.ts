declare module "*.css";
declare module "@gcode/ui/styles.css";
...
interface ImportMetaEnv {
  ...
  readonly VITE_GCODE_BASE_URL?: string;
  readonly VITE_GCODE_ENDPOINT_ORIGIN?: string;
  readonly VITE_GCODE_WEB_REMOTE_CONTROL_RELAY_WS_URL?: string;
}
